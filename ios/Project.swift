		...
		projectPackages
			.append(
				.remote(
					...
					requirement: .upToNextMajor(from: "11.11.0")
				)
			)
	...
	func addAdsKit() {
		...
		let adsKitTarget: Target = .target(
			...
			infoPlist: .extendingDefault(with: [
				"GADApplicationIdentifier": "ca-app-pub-5999809421020926~2338332220",
				"GADNativeAdValidatorEnabled": "NO"
			]),
			sources: ["Targets/\(targetName)/Sources/**"],
			resources: [baseAppResources],
